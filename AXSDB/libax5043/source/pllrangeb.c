...
uint8_t ax5043_pllrangeb(uint8_t range)
{
    ...
    radio_write8(AX5043_REG_PLLRANGINGB, 0x10 | (range & 0x0f));  // start value typical 0x08

    do
    {
        delay(2000);
        r = radio_read8(AX5043_REG_PLLRANGINGB);
	if (!(r & 0x10))
		break;
    } while (--rcount);

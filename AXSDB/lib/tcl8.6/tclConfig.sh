...
# installed.
TCL_PREFIX='/usr/i686-w64-mingw32/sys-root/mingw'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/usr/i686-w64-mingw32/sys-root/mingw'
...
TCL_RANLIB='/usr/bin/i686-w64-mingw32-ranlib'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/usr/lib/build_win32 -ltcl86'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/usr/i686-w64-mingw32/sys-root/mingw/lib -ltcl86'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/usr/i686-w64-mingw32/sys-root/mingw/include'
...
# compiled.
TCL_SRC_DIR='/usr/include/mingw-tcl-private'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/usr/i686-w64-mingw32/sys-root/mingw/lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/usr/lib/build_win32 -ltclstub86'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/usr/i686-w64-mingw32/sys-root/mingw/lib -ltclstub86'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/usr/lib/build_win32/libtclstub86.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/usr/i686-w64-mingw32/sys-root/mingw/lib/libtclstub86.a'

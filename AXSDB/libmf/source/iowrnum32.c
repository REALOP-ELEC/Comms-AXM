...
******************************************************************************
* @file iowrnum32.c
* @brief Writing 32 bit number on UART
* @internal
...
#include "axm0_uart.h"
 ...
 __reentrantb uint8_t uart_writenum32(uint32_t val, uint8_t nrdig1, uint8_t flags1) __reentrant
{
#if UART == 0
	return axm0_uart_writenum32(&_uart0_descriptor, val, nrdig1, flags1);
#elif UART == 1
	return axm0_uart_writenum32(&_uart1_descriptor, val, nrdig1, flags1);
#endif
}
#endif /* UART == 0 ||  UART == 1 */

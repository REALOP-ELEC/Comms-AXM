...
******************************************************************************
* @file iowrhex32.c
* @brief Writes 32 bit hexadecimal number on UART
* @internal
...
__reentrantb uint8_t uart_writehex32(uint32_t val, uint8_t nrdig1, uint8_t flags1) __reentrant
{
#if UART == 0
	return axm0_uart_writehex32(&_uart0_descriptor, val, nrdig1, flags1);
#elif UART == 1
	return axm0_uart_writehex32(&_uart1_descriptor, val, nrdig1, flags1);
#endif
}
#endif /* UART == 0 ||  UART == 1 */
#else

...
******************************************************************************
* @file radiord24.c
* @brief 24 bit read of radio register
* @internal
...
__reentrantb uint32_t _radio_read24(uint32_t addr) __reentrant
{
	return _radio_spi_io(0x00, addr, 0, 3);
}
...
__reentrantb uint32_t _radio_read24(uint32_t addr) __reentrant
{
	return (*_radio_addr(addr, 0x2000000)) & 0xFFFFFF;
}

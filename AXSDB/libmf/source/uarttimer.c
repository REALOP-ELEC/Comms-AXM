...
#if TIMER == 0
	CMU->PCLK_CFG_b.TIM0_EN = 1;
	axm0_uart_timer_baud(TIM, clksrc, baud, clkfreq);
#elif TIMER == 1
	CMU->PCLK_CFG_b.TIM1_EN = 1;
	axm0_uart_timer_baud(TIM1, clksrc, baud, clkfreq);
#elif TIMER == 2
...
{
#if TIMER == 0
	PERI->DIV_16_CTL0 = uart_timer_baud_int(baud, clkfreq);
	PERI->DIV_CMD = 0x8000FF40u;
#elif TIMER == 1
	PERI->DIV_16_CTL1 = uart_timer_baud_int(baud, clkfreq);
	PERI->DIV_CMD = 0x8000FF41u;
#elif TIMER == 2
	PERI->DIV_16_CTL2 = uart_timer_baud_int(baud, clkfreq);
	PERI->DIV_CMD = 0x8000FF42u;
#elif TIMER == 3
	PERI->DIV_16_CTL3 = uart_timer_baud_int(baud, clkfreq);
	PERI->DIV_CMD = 0x8000FF43u;
#elif TIMER == 4
	PERI->DIV_16_CTL4 = uart_timer_baud_int(baud, clkfreq);
	PERI->DIV_CMD = 0x8000FF44u;
#elif TIMER == 5
	PERI->DIV_16_CTL5 = uart_timer_baud_int(baud, clkfreq);
	PERI->DIV_CMD = 0x8000FF45u;
#elif TIMER == 6
	PERI->DIV_16_5_CTL0 = uart_timer_baud_frac(baud, clkfreq);
	PERI->DIV_CMD = 0x8000FF80u;
#elif TIMER == 7
	PERI->DIV_16_5_CTL1 = uart_timer_baud_frac(baud, clkfreq);
	PERI->DIV_CMD = 0x8000FF81u;
#elif TIMER == 8
	PERI->DIV_16_5_CTL2 = uart_timer_baud_frac(baud, clkfreq);
	PERI->DIV_CMD = 0x8000FF82u;
#endif
}

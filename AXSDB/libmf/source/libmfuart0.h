...
#define UART0_DEFINE_RXBUFFER(sz)                               \
uint8_t __data uart0_rxbuffer[sz];                              \
const uint16_t __code uart0_rxbuffer_size = sz;

#define UART0_DEFINE_TXBUFFER(sz)                               \
uint8_t __data uart0_txbuffer[sz];                              \
const uint16_t __code uart0_txbuffer_size = sz;
...
extern __reentrantb uint8_t uart0_txbusy(void) __reentrant __naked;
...
extern __reentrantb void uart0_writestr(const char __genericaddr *ch) __reentrant;

...
uint8_t crc8_onewire(const __genericaddr uint8_t *buf, uint8_t len, uint8_t init) __reentrant __naked
{
	buf;
	len;
	init;
...
__reentrantb uint8_t crc8_onewire(const uint8_t __genericaddr *buf, uint8_t len, uint8_t init) __reentrant
{
	do {

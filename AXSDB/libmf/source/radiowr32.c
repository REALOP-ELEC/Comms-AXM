...
******************************************************************************
* @file radiowr32.c
* @brief 32 bit write to radio register
* @internal
...
__reentrantb void _radio_write32(uint32_t addr, uint32_t d) __reentrant
{
	_radio_spi_io(0x80, addr, d, 4);
}
